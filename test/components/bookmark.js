...
test('bookmark component', (t) => {
  ...
  sinon.spy(Bookmark.prototype, 'getWebsite')
  sinon.spy(Bookmark.prototype, 'destroyBookmark')
  ...
  t.ok(Bookmark.prototype.getTimeString.called, 'It called getTimeString at least once')
  t.ok(Bookmark.prototype.getWebsite.called, 'It called getWebsite at least once')

  destroyLink.simulate('click', {
    preventDefault: sinon.spy()
  })

  t.ok(Bookmark.prototype.destroyBookmark.called, 'It calls destroyBookmark when clicked')
