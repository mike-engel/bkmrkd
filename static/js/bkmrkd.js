...
var _mike_engel$bkmrkd$Router$compareRoutes = F2(
	function (a, b) {
...
var _mike_engel$bkmrkd$Router$parseLocation = function (location) {
	var _p1 = A2(_evancz$url_parser$UrlParser$parsePath, _mike_engel$bkmrkd$Router$matchers, location);
	if (_p1.ctor === 'Just') {
		return _p1._0;
	} else {
...
var _mike_engel$bkmrkd$Store$initialModel = F2(
...
var _mike_engel$bkmrkd$Store$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {alert: a, bookmarks: b, currentPage: c, currentPageNumber: d, searchResults: e, searchTerm: f, urlPrefix: g};
	});
var _mike_engel$bkmrkd$Store$Bookmark = F4(
	function (a, b, c, d) {
...
var _mike_engel$bkmrkd$Store$decodeBookmark = A5(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _mike_engel$bkmrkd$Store$decodeBookmarks = _elm_lang$core$Json_Decode$list(_mike_engel$bkmrkd$Store$decodeBookmark);
...
var _mike_engel$bkmrkd$Store$deleteBookmark = function (id) {
	...
	return A2(_elm_lang$http$Http$send, _mike_engel$bkmrkd$Store$BookmarkDeleteRequest, request);
};
...
var _mike_engel$bkmrkd$Store$searchBookmarks = function (searchTerm) {
	var url = A2(_elm_lang$core$Basics_ops['++'], '/api/search?term=', searchTerm);
	var request = A2(_elm_lang$http$Http$get, url, _mike_engel$bkmrkd$Store$decodeBookmarks);
	return A2(_elm_lang$http$Http$send, _mike_engel$bkmrkd$Store$BookmarkSearchRequest, request);
};
...
var _mike_engel$bkmrkd$Store$getBookmarks = function (pageNumber) {
	...
	var request = A2(_elm_lang$http$Http$get, url, _mike_engel$bkmrkd$Store$decodeBookmarks);
	return A2(_elm_lang$http$Http$send, _mike_engel$bkmrkd$Store$BookmarkFetchRequest, request);
};
				...
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alert: {ctor: '_Tuple2', _0: 'error', _1: 'There was a problem fetching your bookmarks. Please try again.'}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alert: {ctor: '_Tuple2', _0: 'error', _1: 'There was a problem searching through your bookmarks. Please try again.'}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alert: {ctor: '_Tuple2', _0: 'error', _1: 'There was a problem deleting that bookmark. Please try again.'}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'OnLocationChange':
				...
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						currentPageNumber: _mike_engel$bkmrkd$Store$getUrlPageNumber(_p6.search)
					});
				var _p5 = newRoute;
				switch (_p5.ctor) {
					case 'BookmarksRoute':
...
var _mike_engel$bkmrkd$Helpers$navigationOptions = {stopPropagation: false, preventDefault: true};
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('bookmark__source'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(bookmark.url),
										_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('bookmark__delete'),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: A3(
													...
													_elm_lang$core$Json_Decode$succeed(
														_mike_engel$bkmrkd$Store$DeleteBookmark(bookmark.id))),
												_1: {ctor: '[]'}
											}
										}
									},
...
var _mike_engel$bkmrkd$Alert$view = function (model) {
	...
	var alertClassName = _mike_engel$bkmrkd$Alert$isHidden(alertType) ? 'alert--hidden' : A2(_elm_lang$core$Basics_ops['++'], 'alert--', alertType);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$class(
						A2(_elm_lang$core$Basics_ops['++'], 'site-constraint alert ', alertClassName)),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A3(
									...
									'click',
									_mike_engel$bkmrkd$Helpers$navigationOptions,
									_elm_lang$core$Json_Decode$succeed(_mike_engel$bkmrkd$Store$ClearAlert)),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _mike_engel$bkmrkd$Bookmarks$emptyBookmarks = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('You don\'t have any bookmarks saved yet! As soon as you add one, it will show up here.'),
		_1: {ctor: '[]'}
	});
var _mike_engel$bkmrkd$Bookmarks$bookmarksList = function (bookmarks) {
	return _elm_lang$core$Native_Utils.eq(
		...
		_1: {ctor: '[]'}
	} : A2(_elm_lang$core$List$map, _mike_engel$bkmrkd$Helpers$bookmarkItem, bookmarks);
};
var _mike_engel$bkmrkd$Bookmarks$stopOrContinue = F2(
	function (page, enabled) {
		return enabled ? _mike_engel$bkmrkd$Store$ChangePageNumber(page) : _mike_engel$bkmrkd$Store$Nothing;
	});
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'pagination__link pagination__link--previous', extraClass)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href(
						A2(
					...
					_1: {
						...
						_0: A3(
							...
							_mike_engel$bkmrkd$Helpers$navigationOptions,
							_elm_lang$core$Json_Decode$succeed(
								A2(_mike_engel$bkmrkd$Bookmarks$stopOrContinue, page - 1, enabled))),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'pagination__link pagination__link--next', extraClass)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href(
						A2(
					...
					_1: {
						...
						_0: A3(
							...
							_mike_engel$bkmrkd$Helpers$navigationOptions,
							_elm_lang$core$Json_Decode$succeed(
								A2(_mike_engel$bkmrkd$Bookmarks$stopOrContinue, model.currentPageNumber + 1, enabled))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _mike_engel$bkmrkd$Bookmarks$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('site-constraint bookmarks-list'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _mike_engel$bkmrkd$Bookmarks$previousButton(model.currentPageNumber),
						_1: {
							ctor: '::',
	...
	},
	{
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('https://mike-engel.com'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$target('_blank'),
								_1: {ctor: '[]'}
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' as an experiment in creating a service tied to a bookmarklet. Since then it\'s been rewritten in '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://nodejs.org'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$target('_blank'),
										_1: {ctor: '[]'}
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('. It\'s used as a playground for new web dev techniques such as isomorphic rendering, service worker, etc.'),
										_1: {ctor: '[]'}
									}
								}
							}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('To add bookmarks here, simply drag the bookmarklet link in the navigation to your bookmarks bar (or favorites bar or whatever) and click it when you\'re on a page you want to save for later.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://github.com/mike-engel/bkmrkd'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$target('_blank'),
										_1: {ctor: '[]'}
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://github.com/mike-engel/bkmrkd/issues'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$target('_blank'),
												_1: {ctor: '[]'}
...
var _mike_engel$bkmrkd$Header$navLink = F4(
	function (currentPage, route, url, title) {
		var active = A2(_mike_engel$bkmrkd$Router$compareRoutes, currentPage, route);
									...
									A2(
										...
										_mike_engel$bkmrkd$Router$SearchRoute(
											_elm_lang$core$Maybe$Just(
												A2(_elm_lang$core$Basics_ops['++'], '/search?term=', model.searchTerm))),
										A2(_elm_lang$core$Basics_ops['++'], '/search?term=', model.searchTerm))),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('header__bookmark-search'),
									_1: {
										ctor: '::',
										_0: _fapian$elm_html_aria$Html_Attributes_Aria$role('form'),
										_1: {
											ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$label,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('header__search-label'),
											_1: {ctor: '[]'}
										}
									},
									{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('header__search-input'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('search-input'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('search your bookmarks'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_mike_engel$bkmrkd$Store$UpdateSearchTerm),
															_1: {ctor: '[]'}
														}
													}
												}
								...
								},
								{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_1: {
												ctor: '::',
												_0: A4(_mike_engel$bkmrkd$Header$navLink, model.currentPage, _mike_engel$bkmrkd$Router$ColophonRoute, '/colophon', 'colophon'),
												_1: {
													ctor: '::',
													_0: A4(
														_mike_engel$bkmrkd$Header$navLink,
														...
														_mike_engel$bkmrkd$Bookmarklet$bookmarkletCode(model.urlPrefix),
														'bookmarklet'),
													_1: {ctor: '[]'}
												}
											}
...
var _mike_engel$bkmrkd$SearchResults$noSearchResults = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('There are no bookmarks with a title like that. Are you sure you spelled it right?'),
		_1: {ctor: '[]'}
	});
var _mike_engel$bkmrkd$SearchResults$searchResultsList = function (searchResults) {
	return _elm_lang$core$Native_Utils.eq(
		...
		_1: {ctor: '[]'}
	} : A2(_elm_lang$core$List$map, _mike_engel$bkmrkd$Helpers$bookmarkItem, searchResults);
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$ul,
				{ctor: '[]'},
				_mike_engel$bkmrkd$SearchResults$searchResultsList(model.searchResults)),
			_1: {ctor: '[]'}
		});
};
...
var _mike_engel$bkmrkd$Bkmrkd$init = function (location) {
	...
	var model = A2(_mike_engel$bkmrkd$Store$initialModel, currentRoute, location);
	return A2(
